...
const generateManager = (manager) => {
            // Indentation is pushed over in this js file so the generated html the user sees will
                ...
                <article class="col-4 mt-3">
                    <div class="card">
                        ...
                        <section class="card-body bg-light">
                            ...
                            <p class="p-2 m-1 bg-white border">Email: <a href="mailto:${manager.email}">${manager.email}</a></p>
                ...
                <article class="col-4 mt-3">
                    <div class="card">
                        ...
                        <section class="card-body bg-light">
                            ...
                            <p class="p-2 m-1 bg-white border">Email: <a href="mailto:${engineer.email}">${engineer.email}</a></p>
                ...
                <article class="col-4 mt-3">
                    <div class="card">
                        ...
                        <section class="card-body bg-light">
                            ...
                            <p class="p-2 m-1 bg-white border">Email: <a href="mailto:${intern.email}">${intern.email}</a></p>
